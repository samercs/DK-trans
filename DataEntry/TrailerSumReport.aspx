<%@ Page Title="تقرير ملخص حركة المقطورات مع الرؤوس" Language="C#" MasterPageFile="~/DataEntry/Reports.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tonnage_Sum" HeaderText="مجموع الحمولة" ReadOnly="True" 
                SortExpression="Tonnage_Sum" />
            <asp:BoundField DataField="Tonnage2_Sum" HeaderText="مجموع التفريغ" ReadOnly="True" 
                SortExpression="Tonnage2_Sum" />
            <asp:BoundField DataField="Net_Sum" HeaderText="مجموع الصافي" ReadOnly="True" 
    ...
    <table class="tr1" width="90%">
        <tr>
            <td>
                عدد النقلات : <%=GetSum(1) %>
            </td>
            
            <td>
                مجموع اوزان التحميل : <%=GetSum(2) %>
            </td>
            
            <td>
                مجموع اوزان التفريغ : <%=GetSum(3) %>
            </td>
            <td>
                مجموع الفروق : <%=GetSum(4) %>
            </td>
        </tr>
    </table>
</asp:Content>
