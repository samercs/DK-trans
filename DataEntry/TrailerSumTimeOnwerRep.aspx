...
<script runat="server">
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataSource2.SelectParameters["Owner"].DefaultValue = DropDownList1.SelectedValue;
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" Runat="Server">
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT [id], [Number] FROM [Trailer] WHERE ([Owner] = @Owner) ORDER BY [Number] DESC">
        <SelectParameters>
