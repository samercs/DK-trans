<%@ Page Title="تقرير حركات القاطرات الماليكين في فترة محددة" Language="C#" MasterPageFile="Reports.master" %>
...
<table width="100%">
    ...
    <table class="LogInTable" align="center">
        <tr>
            <td class="Title">
              تقرير حركات القاطرات الماليكين في فترة محددة
            </td>
        </tr>
        <tr>
            <td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" Runat="Server">
    <table   class="LogInTable">
        <tr class="tr1 Center">
            <td></td>
            <td class="tr1 Center">رقم القاطرة</td>
            <%
                DateTime d1 = new DateTime(int.Parse(year1.SelectedValue), int.Parse(month1.SelectedValue), int.Parse(day1.SelectedValue));
                DateTime d2 = new DateTime(int.Parse(year2.SelectedValue), int.Parse(month2.SelectedValue), int.Parse(day2.SelectedValue));
                DateTime tmp;
    ...
    <%
        ...
        cmd.Connection = con;
        cmd.CommandText = "select number,id from Cars Where Owner=@Owner Order By Number DESC";
                ...
                if (d1.CompareTo(d2) <= 0)
                    {
                        ...
                        for (int j = 0; j <= t.Days; j++)
                        {
                            ...
                            %>
                                ...
                                <%
                                    string tmp2 = DataBase.getCarMoveCount(r["id"].ToString(), tmp);
