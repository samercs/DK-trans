<%@ Page Title="مغادرة مركبة" Language="C#" MasterPageFile="~/DataEntry/MasterPage.master" %>
...
<script runat="server">
    ...
    protected void ImageButton1_Command(object sender, CommandEventArgs e)
    {
        ...
        Session["FildID"] = "LeavingTime2";
        Session["FildID2"] = "EnterUserId2";
        Session["FildID3"] = "EnterTime2";
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Transports.id, Drivers.Name AS Driver_Name, Transports.FromId, Transports.ToId, Cars.Number AS Car_Number,  Trailer.Number AS Trailer_Number, Transports.ArrivalTime1, Transports.LeavingTime2, Transports.LeavingTime1, Transports.ArrivalTime2 FROM Transports INNER JOIN Drivers ON Transports.DriverId = Drivers.id INNER JOIN Cars ON Transports.CarID = Cars.id INNER JOIN Trailer ON Transports.TrailerID = Trailer.id where (not(arrivaltime1  is null) and (LeavingTime2 is null))"></asp:SqlDataSource>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="تسجيل مغادرة" >
                <ItemTemplate>
