<%@ Page Title="تعديل الحمولة" Language="C#" MasterPageFile="MasterPage.master" %>
...
<script runat="server">
    ...
    bool isdate(string tem)
    {
        DateTime t;
        bool r ;
        if (DateTime.TryParse(tem, out t))
        {
            r = true;
        }
        else
    ...
    private DateTime GetDate3()
    {
        DateTime Time = DateTime.Now;
        DateTime x = DateTime.Now;
        Time = DateTime.Parse(TextBox10.Text + ":" + TextBox9.Text + ":00");
        x = new DateTime(int.Parse(year3.SelectedValue), int.Parse(month3.SelectedValue), int.Parse(day3.SelectedValue), Time.Hour, Time.Minute, Time.Second);
        return x;
    }
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            if (CheckBox1.Checked)
            {
                if (isdate(TextBox7.Text + ":" + TextBox6.Text + ":00"))
                {
                    x2 = GetDate2();
                    x3 = GetDate3();
                }
            ...
            if (CheckBox1.Checked)
            {
                if (DataBase.UpdateData(DataBase.Transports, new string[] { DataBase.DriverId, DataBase.CarID, DataBase.TrailerID, DataBase.Tonnage, DataBase.Tonnage2, DataBase.LoadNo, DataBase.EmptyingNo, DataBase.FromID, DataBase.ToID, DataBase.LeavingTime1, DataBase.ArrivalTime1,"ArrivalTime",  DataBase.UpdateUserId1,  DataBase.UpdateTime1 }, new string[] { DropDownList1.SelectedValue, DropDownList2.SelectedValue, DropDownList3.SelectedValue, TextBox1.Text, TextBox8.Text, TextBox4.Text, TextBox5.Text, DropDownList4.SelectedValue, DropDownList5.SelectedValue, x.ToString(), x2.ToString(),x3.ToString(), Session["Id"].ToString(),  DateTime.Now.ToString() },"id",Session["PID"].ToString()))
                {
            ...
            {
                if (DataBase.UpdateData(DataBase.Transports, new string[] { DataBase.DriverId, DataBase.CarID, DataBase.TrailerID, DataBase.Tonnage, DataBase.LoadNo, DataBase.FromID, DataBase.ToID, DataBase.LeavingTime1, DataBase.UpdateUserId1, DataBase.UpdateTime1 }, new string[] { DropDownList1.SelectedValue, DropDownList2.SelectedValue, DropDownList3.SelectedValue, TextBox1.Text, TextBox4.Text, DropDownList4.SelectedValue, DropDownList5.SelectedValue, x.ToString(), Session["Id"].ToString(), DateTime.Now.ToString() },"id",Session["PID"].ToString()))
                {
                    msg = new Message("تم تعديل الحمولة", true, "Loads.aspx", "Loads.aspx");
                }
                else
        ...
        <tr>
            <td>
                <table>
                    ...
                    <tr class="tr2">
                        <td colspan="2">
                            <asp:CheckBox Text="وصلت" ID="CheckBox1" runat="server" OnLoad="CheckBox1_Load" />
                        </td>
                    </tr>
