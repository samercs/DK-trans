        ...
        <tr>
            <td align="center">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT Drivers.Name, Cars.Number AS Cars_Number, Trailer.Number AS Trailer_Number, Centers.Name AS From_Name, Centers_1.Name AS To_Name,Transports.ID, Transports.Tonnage, Transports.Tonnage2,Transports.ArrivalTime, Transports.LoadNo, Transports.EmptyingNo,Transports.DocNo, Transports.LeavingTime1, Transports.ArrivalTime1, Transports.EnterUserId1, Transports.UpdateUserId1, Transports.EnterTime1, Transports.UpdateTime1 FROM Centers INNER JOIN Cars INNER JOIN Transports INNER JOIN Drivers ON Transports.DriverId = Drivers.id ON Cars.id = Transports.CarID INNER JOIN Trailer ON Transports.TrailerID = Trailer.id ON Centers.id = Transports.FromId INNER JOIN Centers AS Centers_1 ON Transports.ToId = Centers_1.id where year(Transports.LeavingTime1)=@year and month(Transports.LeavingTime1)=@month and day(Transports.LeavingTime1)=@day Order By Transports.LeavingTime1">
                <SelectParameters>
                ...
                <table class="LogInTable">
                    ...
                    <tr>
                        <td>رقم الوصل</td>
			<td>
				<asp:TextBox Width="50" ID="DocNoSearch" CssClass="Text" runat="server" AutoPostBack="True" OnTextChanged="DocNoSearch_TextChanged"></asp:TextBox>
			</td>
			<td colspan="2">
                ...
                <asp:GridView DataSourceID="SqlDataSource1" ID="GridView1" runat="server" 
                    ...
                    GridLines="Both"  Width="1100" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" PageSize="40" AllowSorting="true">
			...
			<asp:BoundField DataField="DocNo" HeaderText="رقم الوصل" 
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton CommandArgument='<%#Eval("id") %>' ImageUrl="~/Images/Delete.png" Width="25" Height="20" OnClientClick="return confirm('هل متاكد من حذف الحمولة');" ID="ImageButton2" runat="server" OnCommand="ImageButton2_Command" />
                    </ItemTemplate>
                </asp:TemplateField>    
                    </Columns>
                    <EmptyDataTemplate>
