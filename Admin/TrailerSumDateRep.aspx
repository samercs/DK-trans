<%@ Page Title="تقرير حركات جميع المقطورات في فترة محددة" Language="C#" MasterPageFile="Reports.master" %>
...
<table width="100%">
    ...
    <table class="LogInTable" align="center">
        <tr>
            <td class="Title">
                تقرير حركات جميع المقطورات في فترة محددة
            </td>
        </tr>
        <tr>
            <td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <%
        ...
        cmd.Connection = con;
        cmd.CommandText = "select number,id from trailer Order By Number DESC";
        SqlDataReader r;
        con.Open();
        r = cmd.ExecuteReader();
        int i;
                ...
                if (d1.CompareTo(d2) <= 0)
                    {
                        ...
                        for (int j = 0; j <= t.Days; j++)
                        {
                            ...
                            %>
                                ...
                                <%
                                    string tmp2 = DataBase.getTrailerMoveCount(r["id"].ToString(), tmp);
