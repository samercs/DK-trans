...
<asp:Content ContentPlaceHolderID="Header" ID="C1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td colspan="2" align="center">
                المالك <%=DataBase.GetPName("Owners","name","id",Session["owner"].ToString()) %>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center"> من &nbsp;&nbsp;&nbsp;<%=DataBase.GetPName("Centers","name","id",Session["from"].ToString()) %>&nbsp;&nbsp;&nbsp; الى &nbsp;&nbsp;&nbsp;<%=DataBase.GetPName("Centers","name","id",Session["to"].ToString()) %></td>
        </tr>
    </table>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <asp:GridView  ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Car_Number" HeaderText="رقم القاطر" 
            ...
            <asp:BoundField DataField="LeavingTime1" 
                HeaderText="تاريخ المغادرة" DataFormatString="{0:dd/MM/yyyy}" SortExpression="LeavingTime1" />
                
            <asp:BoundField DataField="ArrivalTime1" 
                HeaderText="تاريخ الوصول" DataFormatString="{0:dd/MM/yyyy}" SortExpression="ArrivalTime1" />
           ...
           <asp:BoundField DataFormatString="{0:###,###,###}" DataField="Tonnage2" 
                HeaderText="التفريغ" SortExpression="Tonnage2" />   
    ...
    <table class="tr1" width="98%">
        <tr>
            <td>
                عدد الحمولات : <%=GridView1.Rows.Count %>
            </td>
            
            <td>
                مجموع التحميلات : <%=GetSum(10).ToString("###,###,###") %>
            </td>
            
            <td>
                مجموع التفريغ : <%=GetSum(11).ToString("###,###,###")%>
            </td>
            <td>
