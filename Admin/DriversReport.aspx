<%@ Page Title="تقرير حركات السائق" Language="C#" MasterPageFile="Reports.master" %>
...
<script runat="server">
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.SelectParameters["DriverID"].DefaultValue = DropDownList1.SelectedValue.ToString();
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="LeavingTime1" 
                HeaderText="تاريخ التحميل" DataFormatString="{0:dd/MM/yyyy&nbsp;&nbsp;hh:mm}" SortExpression="LeavingTime1" />
                
            <asp:BoundField DataField="ArrivalTime1" 
                HeaderText="تاريخ التفريغ" DataFormatString="{0:dd/MM/yyyy&nbsp;&nbsp;hh:mm}" SortExpression="ArrivalTime1" />
            ...
            <asp:BoundField DataField="Tonnage" DataFormatString="{0:###,###,###}"
                HeaderText="الحمولة" SortExpression="Tonnage" />  
             
           <asp:BoundField DataField="Tonnage2" DataFormatString="{0:###,###,###}"
                HeaderText="وزن التفريغ" SortExpression="Tonnage2" />   
                
           <asp:BoundField DataField="Difrent" DataFormatString="{0:###,###,###}"
