<%@ Page Title="المحطات" Language="C#" MasterPageFile="MasterPage.master" %>
...
<script runat="server">
    ...
    protected void ImageButton1_Command(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("CentersEdit.aspx");
    }

    protected void ImageButton2_Command(object sender, CommandEventArgs e)
    {
        System.Data.DataTable dt = DataBase.GetData("Transports", new string[] {"FromId" }, new string[] {e.CommandArgument.ToString() });
        System.Data.DataTable dt2 = DataBase.GetData("Transports", new string[] { "ToId" }, new string[] { e.CommandArgument.ToString() });

        if (dt.Rows.Count == 0 && dt2.Rows.Count == 0)
        {
            if (DataBase.Delete("Centers", "id", e.CommandArgument.ToString()))
            {
                Message msg = new Message("تم حذف المحطة", true, "Centers.aspx", "Centers.aspx");
                Session["MSG"] = msg;
        ...
        {
            Message msg = new Message("يوجد حمولات مدخلة باسم هذة المنطقة . لا يمكن حذف هذة المنطقة", false, "Centers.aspx", "Centers.aspx");
            Session["MSG"] = msg;
            Response.Redirect("Message.aspx");
        }
    }
...
<center>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Centers] ORDER BY [Name]"></asp:SqlDataSource>
    <br />
    <br />
    <a href="CentersAdd.aspx">اضافة محطة جديد</a>
    <br />
    <br />
