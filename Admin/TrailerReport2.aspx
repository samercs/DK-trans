<%@ Page Title="تقرير حركات مقطورة" Language="C#" MasterPageFile="Reports.master" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            SqlDataSource1.SelectParameters["CarID"].DefaultValue = Session["CarId"].ToString();
...
<asp:Content ContentPlaceHolderID="Header" ID="c1" runat="server">
    ...
    <table align="center">
        ...
        <tr>
            <td>
                في الفترة من <%=DateTime.Parse(Session["d1"].ToString()).ToString("dd/MM/yyyy") %> الى <%=DateTime.Parse(Session["d2"].ToString()).ToString("dd/MM/yyyy") %> 
            </td>
        </tr>
        
        <tr>
            <td>
                سيارة رقم <%= Session["CarId"].ToString() %>
            </td>
        </tr>
     </table>
   ...
   <table width="100%">
    ...
    <table class="tr1" width="100%">
        <tr>
            ...
            <td>
                مجموع اوزان التحميل : <%=GetSum(9).ToString("###,###,###") %>
            </td>
            
            <td>
                مجموع اوزان التفريغ : <%=GetSum(10).ToString("###,###,###")%>
            </td>
            <td>
                مجموع الوزن الصافي : <%=GetSum(11, "r").ToString("###,###,###")%>
            </td>
        </tr>
    </table>
